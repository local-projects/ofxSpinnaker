...
namespace AdapterConfig
{
    ...
    ADAPTERCONFIG_API std::string GetGatewayAddress(const std::string& ipAddrStr, unsigned int subnetMaskLength);
    ...
    ADAPTERCONFIG_API std::string GetAutoStartGateway();
} // namespace AdapterConfig
