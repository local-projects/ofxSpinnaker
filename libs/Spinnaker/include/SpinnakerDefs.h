...
namespace Spinnaker
{
    ...
    /**
     * Color processing algorithms. Please refer to our knowledge base
    ...
    /* clang-format off */
    DEPRECATED_ENUM("This enum has been deprecated. Polarization images are now created through specific "
                        "functions in the ImageUtilityPolarization class.")
    ...
    DEPRECATED_ENUM("This enum has been deprecated. Image scaling can now be applied through specific functions "
                        "defined in the ImageUtility class.")
    ...
    DEPRECATED_ENUM("This enum has been deprecated. Please use HeatmapColor in the ImageUtilityHeatmap class.")
    HeatMapColor
    {
        HEATMAP_BLACK = 1,
        HEATMAP_BLUE = 2,
